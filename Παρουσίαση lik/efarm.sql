...
CREATE TABLE `orders` (
  ...
  `sendLocation` varchar(45) NOT NULL,
...
CREATE TABLE `product` (
  ...
  `publicLocal` varchar(45) NOT NULL,
...
CREATE TABLE `user` (
  ...
  `valid` varchar(45) CHARACTER SET utf8 NOT NULL,
...
--
-- Dumping routines for database 'efarm'
--
...
-- Dump completed on 2018-05-23 11:47:14
